...
STR = {
 "en": {"app_title": "IT Project Portfolio Risk Analyzer", "configure": "Configure", "results": "Results",
   ...
   "load_err": "Model artifacts could not be loaded. This folder needs model_pipeline.joblib, feature_defaults.joblib and project_risk_raw_dataset.csv. Run masterskript.py first if the model files are missing.",
 ...
 "de": {"app_title": "IT-Projektportfolio-Risikoanalyse", "configure": "Konfigurieren", "results": "Ergebnisse",
   ...
   "load_err": "Modell-Artefakte konnten nicht geladen werden. In diesem Ordner werden model_pipeline.joblib, feature_defaults.joblib und project_risk_raw_dataset.csv benötigt. Fehlen die Modelldateien, zuerst masterskript.py ausf\u00fchren.",
...
DE_LABEL = {
 ...
 "Cross_Functional_Dependencies": "Anzahl bereichs\u00fcbergreifender Abh\u00e4ngigkeiten",
 "External_Dependencies_Count": "Anzahl externer Abh\u00e4ngigkeiten", "Technology_Familiarity": "Technologievertrautheit",
 "Tech_Environment_Stability": "Stabilit\u00e4t der technischen Umgebung", "Technical_Debt_Level": "Technische Schulden",
 "Requirement_Stability": "Anforderungsstabilit\u00e4t", "Change_Request_Frequency": "H\u00e4ufigkeit von \u00c4nderungsantr\u00e4gen",
 "Team_Size": "Teamgr\u00f6\u00dfe", "Stakeholder_Count": "Anzahl der Anspruchsgruppen", "Geographical_Distribution": "Anzahl der Standorte",
 "Project_Budget_USD": "Projektbudget", "Budget_Utilization_Rate": "Budgetaussch\u00f6pfung",
 "Estimated_Timeline_Months": "Gesch\u00e4tzte Laufzeit", "Resource_Availability": "Ressourcenverf\u00fcgbarkeit",
 "Resource_Contention_Level": "Ressourcenkonkurrenz", "Current_Phase_Duration_Months": "Dauer der aktuellen Phase",
 "Communication_Frequency": "Kommunikationsfrequenz", "Documentation_Quality": "Dokumentationsqualit\u00e4t",
 "Org_Process_Maturity": "Prozessreife der Organisation", "Team_Experience_Level": "Erfahrungsniveau des Teams",
 "Project_Manager_Experience": "Erfahrung der Projektleitung", "Past_Similar_Projects": "Anzahl vergleichbarer Vorprojekte",
 "Previous_Delivery_Success_Rate": "Erfolgsquote bisheriger Projektabschl\u00fcsse", "Methodology_Used": "Eingesetzte Arbeitsweise",
 "Team_Colocation": "Pr\u00e4senzgrad des Teams", "Historical_Risk_Incidents": "Anzahl fr\u00fcherer Risikovorf\u00e4lle",
 "Risk_Management_Maturity": "Reife des Risikomanagements", "Change_Control_Maturity": "Reife der \u00c4nderungssteuerung",
 "Vendor_Reliability_Score": "Zuverl\u00e4ssigkeit der Lieferanten", "Team_Turnover_Rate": "Fluktuation im Team",
 ...
 "Seasonal_Risk_Factor": "Saisonaler Risikofaktor", "Executive_Sponsorship": "R\u00fcckhalt in der Unternehmensleitung",
 "Stakeholder_Engagement_Level": "Einbindung der Anspruchsgruppen", "Key_Stakeholder_Availability": "Verf\u00fcgbarkeit zentraler Anspruchsgruppen",
...
EXPL = {
    ...
    "External_Dependencies_Count": ("Anzahl der Abhängigkeiten von externen Parteien (Lieferanten, Partner).", "Number of dependencies on external parties (vendors, partners)."),
    ...
    "Change_Request_Frequency": ("Häufigkeit von Änderungsanträgen (relativer Wert; höher = mehr Änderungen).", "Frequency of change requests (relative value; higher = more changes)."),
    "Team_Size": ("Anzahl der Teammitglieder.", "Number of team members."),
    "Stakeholder_Count": ("Anzahl beteiligter Anspruchsgruppen. Mehr = abstimmungsintensiver.", "Number of stakeholders involved. More = more coordination."),
    "Geographical_Distribution": ("Anzahl der Standorte, auf die sich das Team verteilt.", "Number of sites the team is spread across."),
    ...
    "Past_Similar_Projects": ("Anzahl vergleichbarer Vorprojekte (mehr = mehr Erfahrung).", "Number of past similar projects (more = more experience)."),
    ...
    "Methodology_Used": ("Eingesetzte Arbeitsweise (Agile, Scrum, Kanban).", "Way of working used (Agile, Scrum, Kanban)."),
    "Team_Colocation": ("Präsenzgrad des Teams (voll vor Ort bis voll remote).", "Physical distribution of the team (fully colocated to fully remote)."),
    ...
    "Vendor_Reliability_Score": ("Zuverlässigkeit externer Lieferanten (0 % bis 100 %).", "Reliability of external suppliers (0% to 100%)."),
    "Team_Turnover_Rate": ("Erwartete Fluktuation im Team (0 % bis 100 %).", "Expected team turnover (0% to 100%)."),
    ...
    "Executive_Sponsorship": ("Rückhalt in der Unternehmensleitung (Schwach bis Stark).", "Backing by executive management (Weak to Strong)."),
    "Stakeholder_Engagement_Level": ("Einbindung der Anspruchsgruppen (Schlecht bis Ausgezeichnet).", "Level of stakeholder engagement (Poor to Excellent)."),
    "Key_Stakeholder_Availability": ("Verfügbarkeit zentraler Anspruchsgruppen (Schlecht bis Ausgezeichnet).", "Availability of key stakeholders (Poor to Excellent)."),
    ...
    "Client_Experience_Level": ("Wie eingespielt die Geschäftsbeziehung zum Kunden ist (Erstmalig bis Strategisch).", "How established the business relationship with the client is (First-time to Strategic)."),
    "Organizational_Change_Frequency": ("Häufigkeit organisatorischer Veränderungen im Umfeld.", "Frequency of organisational change in the project environment."),
...
DEFS = {
    ...
    "Change_Request_Frequency": (
        "Änderungsantrag: ein förmliches Ersuchen, den vereinbarten Leistungsumfang während des laufenden Projekts zu ändern.",
        "Change request: a formal request to alter the agreed scope while the project is running."),
    "Change_Control_Maturity": (
        "Änderungssteuerung: das geregelte Verfahren, mit dem Änderungsanträge bewertet, genehmigt und dokumentiert werden. Der Reifegrad beschreibt, wie verbindlich dieses Verfahren ist.",
    ...
    "Stakeholder_Count": (
        "Anspruchsgruppen: alle Personen und Gruppen, die vom Projekt betroffen sind oder es beeinflussen können, etwa Auftraggeber, Fachbereiche, Nutzer oder Betriebsrat.",
    ...
    "Stakeholder_Engagement_Level": (
        "Einbindung: wie aktiv die Anspruchsgruppen informiert, beteiligt und in Entscheidungen einbezogen werden.",
        "Engagement: how actively stakeholders are informed, involved and included in decisions."),
    "Key_Stakeholder_Availability": (
        "Zentrale Anspruchsgruppen: die wenigen Personen, ohne deren Entscheidung oder Zuarbeit das Projekt nicht vorankommt.",
        "Key stakeholders: the few people without whose decisions or input the project cannot move forward."),
    "Executive_Sponsorship": (
        "Rückhalt in der Unternehmensleitung: die Unterstützung durch eine Führungskraft, die das Projekt gegenüber der Organisation vertritt, Ressourcen sichert und bei Konflikten entscheidet.",
    ...
    "Team_Colocation": (
        "Präsenzgrad: wie weit das Team am selben Ort arbeitet. Voll vor Ort bedeutet ein gemeinsames Büro, voll remote bedeutet vollständig verteilte Arbeit.",
    ...
    "Organizational_Change_Frequency": (
        "Organisatorische Veränderung: Umbau von Strukturen im Umfeld des Projekts, etwa Umstrukturierung, Führungswechsel oder neue Zuständigkeiten.",
    ...
    "Budget_Utilization_Rate": (
        "Budgetausschöpfung: der Anteil des geplanten Budgets, der voraussichtlich verbraucht wird. Werte über 100 % zeigen eine erwartete Überschreitung an.",
...
def _join_names(names):
    ...
    sep = " und " if ss.lang == "de" else " and "
    return ", ".join(q[:-1]) + sep + q[-1]
    ...
    with st.container(border=True):
        ...
        if saved is not None:
            ...
            st.markdown(
                ...
                f"<div style='font-size:0.95rem; font-weight:600; color:{GREEN}; text-align:center;'>"
                f"\u2713 {T('n_individual', n=n, t=len(feats))}</div></div>",
                unsafe_allow_html=True)
...
def render_project_details(order, proba, params):
    ...
    if pos or neg:
        ...
        tips = []
        if up_names:
            tips.append(T("advice_up", feats=_join_names(up_names)))
        if down_names:
            tips.append(T("advice_down", feats=_join_names(down_names)))
        st.markdown(
    ...
    st.markdown(f"<div class='cat-header' style='margin:1.2rem 0 0.8rem 0;'>{T('set_params')}</div>",
                unsafe_allow_html=True)
